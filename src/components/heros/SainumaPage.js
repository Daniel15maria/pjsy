...
const SainumaPage = () => {
    return (
        <div className='justify-text'>
            ...
            <Container>
                <Row>
                    <motion.div variants={upvariants} initial="initial" animate="animate" className='each-subhead text-center my-3' >
                        SAINUMA’s Symphony: From Burden to Beacon
                    </motion.div>

                    <motion.div variants={upvariants} initial="initial" animate="animate" className='quotes-head text-center px-4'>“For those who said, I CANNOT – look at me I CAN and I DID” <br /> – Sainuma Kumari</motion.div>
                    ...
                    <Col lg={8}>
                        <motion.div variants={rightVarient} initial="initial" animate="animate" className='lead pt-4 mt-lg-2'>
                ...
                <Row>
                    ...
                    <Col lg={3} md={6} sm={6} xs={6} className='d-flex mb-2 align-items-center justify-content-center'>
                        <motion.img className='img-fluid rounded' src={sainuma2} alt="sainuma motion.img 1" style={{ maxHeight: '280px' }}
                            variants={rightVarient} initial="initial" animate="animate" />
                    </Col>
            ...
            <Container>
                <Row>
                    <Col lg={4} className='p-4 d-flex align-items-center justify-content-center'>
                        <motion.img className='img-fluid rounded' src={sainuma4} alt="sainuma img 1" variants={leftVarient} initial="initial" animate="animate" />
                    </Col>

                    <Col lg={8}>
                        <motion.div variants={rightVarient} initial="initial" animate="animate" className='lead py-lg-5 px-2'>
            ...
            <Container>
                <Row>
                    <motion.div variants={upvariants} initial="initial" animate="animate" className='lead px-2'>
                ...
                <Row className="justify-content-center">
                    <Col lg={4} md={4} sm={4} xs={6} className="d-flex justify-content-center">
                        <motion.img src={sainuma5} alt="sainuma img 1" className="img-fluid rounded mb-2" variants={leftVarient} initial="initial" animate="animate" />
                    </Col>
                    <Col lg={4} md={4} sm={4} xs={6} className="d-flex justify-content-center">
                        <motion.img src={sainuma6} alt="sainuma img 1" className="img-fluid rounded  mb-2" variants={upvariants} initial="initial" animate="animate" />
                    </Col>
                    <Col lg={4} md={4} sm={4} xs={8} className="d-flex justify-content-center">
                        <motion.img src={sainuma7} alt="sainuma img 1" className="img-fluid rounded" variants={rightVarient} initial="initial" animate="animate" />
                    </Col>
                </Row>
                ...
                <Row className='g-3'>
                    ...
                    <Col lg={12} >
                        <motion.div variants={upvariants} initial="initial" animate="animate" className='lead px-5 text-center mb-4 mt-2 quotes-head'>
