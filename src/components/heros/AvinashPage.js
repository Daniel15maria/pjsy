...
import avinash1 from '../images/Heros/avinash/avinash7.jpg';
...
import avinash7 from '../images/Heros/avinash/avinash1c.jpg';
import '../../index.css';
        ...
        <div className='justify-text'>
            ...
            <Container>
                <Row>
                    ...
                    <Col lg={4}></Col>
                    <Col lg={8}><h2>“Avinash’s existence was etched in shadows” </h2></Col>


                    <Col lg={4} className='p-2 d-flex align-items-center justify-content-center'>
                        <img src={avinashtop} alt="avinash img" className="img-fluid" />
                    </Col>
                    {/* <Col lg={1}></Col> */}
                    <Col lg={8}>
            ...
            <Container className="d-flex align-items-center justify-content-center">
                <Row>
                    ...
                    <Col lg={3} className='d-flex align-items-center justify-content-center'>
                        <img src={avinash1} alt="avinash img 1" className="img-fluid" style={{ height: '320px' }} />
                    </Col>
                    <Col lg={3} className='d-flex align-items-center justify-content-center'>
                        <img src={avinash2} alt="avinash img 2" className="img-fluid" style={{ height: '320px' }} />
                    </Col>
                </Row>
            </Container>
            <Container>
