        ...
        <div className='justify-text'>
            <div style={{ backgroundColor: '#F6ECDA' }}>
                <Container className='d-flex justify-content-center align-items-center'>
                    <Row className='mt-5'>
                        <h1 className='each-head2 mt-5'>YOUTH ANIMATOR TRAINING PROGRAM</h1>
                    </Row>
                </Container>
                <Container className='d-flex justify-content-center align-items-center'>
                    <Row>
                ...
                <Container>
                    <Row className='lead pb-5'>
                        <strong><h4>The Patna Jesuit Youth Commission organized “Youth Animators training Program” in Atmadarshan
                            ...
                            the parish priests and youth in-charges of these parishes for the arrangements.</h4></strong>
                    </Row>
                </Container>
            </div>
