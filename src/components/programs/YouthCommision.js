    ...
    return (
        <div className='justify-text' style={{ backgroundColor: '#F6ECDA' }}>
            ...
            <Container className='d-flex justify-content-center align-items-center'>
                <Row className='mt-5'>
                    <div className='each-head2 mt-5 text-center'>YOUTH COMMISSION MAGIS 2022</div>
                </Row>
            </Container>
            <Container className='d-flex justify-content-center align-items-center'>
                <Row>
            ...
            <Container>
                <Row className='lead pb-5 h-1'>
                    <strong><h5 className='text-center'> Great minds discuss ideas, average minds discuss events and small minds discuss people.
                        - Eleanor Roosevelt</h5><h3>
                            <p>Indeed, the wordings of Roosevelt
                                ...
                                company of each other. The theme of the Magis was, “TO SEE EVERYTHING NEW IN CHRIST”. The youth from 4 dioceses
                                ...
                                thanks to ‘St. Michael’s Jesuit Community’, very specially Frs. Norbert, Mathew and Johnson for their
