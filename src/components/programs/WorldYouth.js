        ...
        <div className='justify-text'>
            <div style={{ backgroundColor: '#F6ECDA' }}>
                <Container className='d-flex justify-content-center align-items-center'>
                    <Row className='mt-5'>
                        <h1 className='mt-5 each-head2 text-center'> WORLD YOUTH DAY - 2023 </h1>
                    </Row>
                </Container>
                <Container className='d-flex justify-content-center align-items-center'>
                    <Row>
                        <Image fluid rounded alt="mission img" src={worldyouth} className="mt-3 mb-3" />
                    </Row>
                </Container>
                        ...
                        <strong>
                            <h3>
                                ...
                                <Row className='justify-content-center'>
                                    <Image fluid rounded src={youthdown} alt='youthdownpic' className="mb-2" />
                                </Row>


                                <p> Then we had AICUF national council meeting from 12 to 15 August 2023 in Chennai. Fr. Prakash went to Chennai from Mumbai. Fr. Jeevan took 5 youth from Patna and Varanasi and reached Chennai on the 12th morning. Our youth participated in the meeting enthusiastically. Then Fr. Prakash went to Vijayawada to participate in JYMSA annual meeting.</p>
                            </h3>
                        </strong>
                    </Row>
                    <Row className='justify-content-center'>
                        <img src={youthmid} alt='youthdownpic' className="mb-5" style={{ minWidth: '100px' }} />
                    </Row>
                </Container>
            </div>
            <Footer />
